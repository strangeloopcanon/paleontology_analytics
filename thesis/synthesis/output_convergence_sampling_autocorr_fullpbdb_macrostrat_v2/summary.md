...
- control_time_loc_coll_occ_prov_macro_area: iid(corr=0.360, p=0.0201, n=40); shift(corr=0.360, p=0.0496, n=40)
- control_time_loc_coll_occ_prov_macro_sections: iid(corr=0.349, p=0.0258, n=40); shift(corr=0.349, p=0.0506, n=40)
- control_time_loc_coll_occ_prov_macro_area_sections: iid(corr=0.241, p=0.137, n=40); shift(corr=0.241, p=0.122, n=40)

## Outputs

- Merged table: `thesis/synthesis/output_convergence_sampling_autocorr_fullpbdb_macrostrat_v2/merged.csv`
- Stats: `thesis/synthesis/output_convergence_sampling_autocorr_fullpbdb_macrostrat_v2/analysis_results.json`
- Figures: `thesis/synthesis/output_convergence_sampling_autocorr_fullpbdb_macrostrat_v2/figures`
