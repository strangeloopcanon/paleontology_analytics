# Research summary (repo: `paleontology_analytics`)

This is a compact, model-friendly summary of what has been built and what we found so far. Most narrative + code lives under `thesis/`.
...
- Dinosaur body mass dataset (cached under research outputs):
